...
public class GuiNivel3 extends JFrame {
	...
	public GuiNivel3() {
		...
		String rutaFotoJuego = this.getClass().getResource("/Images/fondo_nivel3.png").toString();
		...
		String rutaLaberinto = this.getClass().getResource("/Images/laberinto_nivel3.png").toString();
