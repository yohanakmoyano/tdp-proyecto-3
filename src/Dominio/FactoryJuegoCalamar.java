...
public class FactoryJuegoCalamar extends FactoryDominio {
	...
	public Jugador crearJugador() {
		return new Jugador_456(null,0,0);//(new Coordenada(235,441), 100, 3); //agregar valores reales de velocidad y vidas
	}
	...
	public Item CrearItemA() {
		return new Galleta(0,null);//(1,new Coordenada(163,277)); 
	}

	@Override
	public Item CrearItemB() {
		return new Cuchillo(0,null);//(1,new Coordenada(83,97)); 
	}

	@Override
	public Item CrearItemC() {
		return new Energizante(0,null);//(1,new Coordenada(451,137)); 
	}

	@Override
	public Item CrearItemD() {
		return new Bomba(0,null);//(1,new Coordenada(112,379)); 
	}

	@Override
	public Item CrearItemE() {
		return new Dinero(0,null);//(1,new Coordenada(235,345)); 
	}
